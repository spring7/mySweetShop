...
public class MySweetShopApp {

    private static final Logger log = LoggerFactory.getLogger(MySweetShopApp.class);

    private final Environment env;

    public MySweetShopApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes mySweetShop.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MySweetShopApp.class);
